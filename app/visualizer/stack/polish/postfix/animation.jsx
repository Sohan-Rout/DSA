...
const InfixToPostfixVisualizer = () => {
  ...
  const convertInfixToPostfix = () => {
    ...
    conversionSteps.push({
      ...
      char: '',
      action: 'Initialize',
      description: 'Starting conversion process'
    });
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 mb-6">
            ...
            {postfix && currentStep === steps.length - 1 && (
              <div className="mt-4 p-3 rounded-lg bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200">
                <div className="font-bold">Postfix Result:</div>
                <div className="text-2xl font-mono">{postfix}</div>
              </div>
            )}
          </div>
