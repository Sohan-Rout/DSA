...
const BubbleSortQuiz = () => {
  const questions = [
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation: "In the worst case (when the list is sorted in reverse order), Bubble Sort requires O(n²) comparisons and swaps."
    },
    {
      question: "In the array [5, 1, 4, 2, 8], how many swaps occur during the first pass of Bubble Sort?",
      options: [
        "1",
        "2",
        "3",
      ...
      correctAnswer: 2,
      explanation: "First pass swaps (5,1), (5,4), and (5,2) - totaling 3 swaps. The pair (5,8) doesn't need swapping."
    },
    {
      ...
      correctAnswer: 2,
      explanation: "Bubble Sort performs best (O(n)) when the array is already sorted, as it only needs one pass through the array without any swaps."
    },
    {
      ...
      correctAnswer: 3,
      explanation: "Bubble Sort is an in-place algorithm that only requires O(1) additional space for temporary storage during swaps."
    },
    {
      question: "How can you optimize Bubble Sort to stop early if the array becomes sorted?",
      options: [
      ...
      correctAnswer: 1,
      explanation: "Using a flag to track if any swaps occurred during a pass allows the algorithm to terminate early if the array is already sorted."
    },
    {
      question: "Why is Bubble Sort rarely used in practice for large datasets?",
      options: [
      ...
      correctAnswer: 2,
      explanation: "While simple to implement, Bubble Sort's O(n²) time complexity makes it inefficient for large datasets compared to algorithms like QuickSort or MergeSort."
    }
  ];
