          ...
          {sections.map((section, sectionIndex) => (
            <div 
              ...
              className="group relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden
                        transition-all duration-300 hover:shadow-[0_0_0_2px_rgba(59,130,246,0.5)] dark:hover:shadow-[0_0_0_2px_rgba(99,102,241,0.5)]
                        hover:-translate-y-1"
            >
                        ...
                        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                          {subsection.items.map((item, itemIndex) => (
                            <Link
                              key={itemIndex}
                              href={item.path}
                              className="group/item block p-4 rounded-lg border border-gray-200 dark:border-gray-700 
                            ...
                            >
                              <div className="flex items-center justify-between">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-400 group-hover/item:text-blue-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                </svg>
                              </div>
                            </Link>
