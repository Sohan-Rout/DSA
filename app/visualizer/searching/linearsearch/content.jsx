    ...
    <main className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 md:gap-4">
      ...
      <article className="md:col-span-9 max-w-4xl bg-white dark:bg-neutral-950 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
        ...
        {/* Newsletter — inline, directly above Time Complexity.
            NewsletterEmbed renders null below 768px (it stays desktop-only for
            mobile performance), so the wrapper is hidden at the same
            breakpoint — otherwise this leaves an empty padded, bordered box on
            phones. */}
