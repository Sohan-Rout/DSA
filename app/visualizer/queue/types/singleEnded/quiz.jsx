...
const questions = [
    ...
    {
      question: "Which data structure is typically NOT used to implement a queue?",
      options: [
        "Linked List",
        "Array", 
        "Stack",
      ...
      correctAnswer: 2,
      explanation: "While stacks can be used to simulate queues, they aren't used for direct queue implementation as they follow LIFO."
    },
    {
      question: "What does the isEmpty() operation check?",
      options: [
        "If the queue is full",
        "If the queue has exactly one element", 
        "If the queue has no elements",
        "If the queue is implemented correctly"
      ],
      correctAnswer: 2,
      explanation: "isEmpty() returns true when there are no elements in the queue."
    },
    {
      question: "In a linked list implementation, where would you add a new element?",
      options: [
        "At the head node",
        "At the tail node", 
      ...
      correctAnswer: 1,
      explanation: "New elements are added at the tail (rear) in a queue implementation."
    },
    {
      question: "What is a common application of queues?",
      options: [
      ...
      correctAnswer: 1,
      explanation: "Queues are commonly used in CPU scheduling to manage processes in FIFO order."
    },
    {
      question: "How does a single-ended queue differ from a double-ended queue?",
      options: [
        "Single-ended allows operations at both ends",
        "Double-ended allows operations at both ends", 
        "They are identical",
        "Single-ended is faster"
      ],
      correctAnswer: 1,
      explanation: "Double-ended queues (deques) allow insertion/removal at both ends, while single-ended queues are restricted to rear insertion and front removal."
    }
];
