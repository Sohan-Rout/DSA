...
const questions = [
    ...
    {
      question: "Which application would MOST likely use a deque?",
      options: [
        "Implementing recursive function calls",
        "Browser's undo-redo functionality", 
        "Database indexing",
        "Hash collision resolution"
      ],
      correctAnswer: 1,
      explanation: "Deques are excellent for undo-redo as they allow operations at both ends to add and remove actions."
    },
    {
      question: "What is true about a input-restricted deque?",
      options: [
        "Allows insertion at both ends but removal from one",
        "Allows insertion at one end but removal from both", 
        "Is exactly the same as a stack",
        "Cannot implement any queue operations"
      ],
      correctAnswer: 1,
      explanation: "An input-restricted deque allows insertion at only one end but removal from both ends."
    },
    {
      question: "How can a deque be used to check for palindromes?",
      options: [
        "By comparing only the middle elements",
        "By repeatedly comparing and removing front and rear elements", 
        "By sorting the elements first",
        "By using it as a temporary stack"
      ],
      correctAnswer: 1,
      explanation: "Palindrome checking with a deque works by comparing front and rear elements (and removing them) until empty or one element remains."
    },
    {
      question: "In a circular array implementation of a deque, what happens when the array is full?",
      options: [
        "It automatically shrinks",
        "It throws an error by default", 
        "It can either resize or reject new elements (implementation dependent)",
        "It converts to a linked list"
      ],
      correctAnswer: 2,
      explanation: "Behavior depends on implementation - some may resize (with performance cost), while others may have fixed capacity."
    },
    {
      question: "Which property makes deques suitable for work-stealing algorithms in parallel processing?",
      options: [
        "Ability to access both ends simultaneously by different threads",
        "Automatic sorting of elements", 
        "Built-in thread synchronization",
        "Random access capability"
      ],
      correctAnswer: 0,
      explanation: "Work-stealing algorithms benefit from deques because idle threads can steal work from one end while the owner thread processes from the other end."
    }
];
