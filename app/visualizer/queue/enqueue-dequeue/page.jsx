...
const QueueVisualizer = () => {
  ...
  const enqueue = () => {
    ...
    setTimeout(() => {
      setQueue(prev => [...prev, inputValue]); // Add to end (right side)
      setOperation(null);
  ...
  const dequeue = () => {
    ...
    setTimeout(() => {
      setQueue(prev => prev.slice(1)); // Remove from start (left side)
      setOperation(null);
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-black text-gray-800 dark:text-gray-200">
      ...
      <main className="container mx-auto px-6 py-16">
        ...
        <p className="text-lg text-center text-gray-600 dark:text-gray-400 mb-8">
          Visualize <strong>Enqueue</strong> (rear) and <strong>Dequeue</strong> (front) operations (FIFO)
        </p>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
            ...
            <div className="mt-8 bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
              <h3 className="font-semibold mb-2">How Queue Works:</h3>
              <ul className="list-disc pl-5 space-y-1">
                <li><strong className="text-green-600 dark:text-green-400">Enqueue</strong>: Adds to the <strong>rear</strong> (right side)</li>
                <li><strong className="text-yellow-600 dark:text-yellow-400">Dequeue</strong>: Removes from the <strong>front</strong> (left side)</li>
                <li><strong className="text-blue-600 dark:text-blue-400">FIFO</strong>: First element enqueued will be first dequeued</li>
              </ul>
            </div>
          </div>
        </div>
