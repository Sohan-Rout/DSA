...
const Content = () => {
  ...
  const complexity = [
    { points: "Time Complexity: O(n) in the best case, up to O(4^n) in the worst case for the naive version — in practice close to O(n) for most trees since a mismatch usually short-circuits early." },
    { points: "Space Complexity: O(h) — recursion stack depth equals the smaller tree's height." },
  ];
