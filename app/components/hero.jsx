...
const HeroSection = () => {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 text-gray-800">
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            ...
            <a
              href="#"
              className="bg-transparent border border-gray-400 hover:border-amber-500 hover:text-amber-500 text-gray-800 font-semibold py-3 px-6 rounded-lg transition duration-300"
            >
              Explore Features
            </a>
          </div>
        ...
        <div className="md:w-1/2 mt-10 md:mt-0 flex justify-center">
          <div className="relative w-80 h-80 md:w-96 md:h-96 perspective-1000 flex items-center justify-center">
            ...
            <div className="relative w-48 h-48 md:w-64 md:h-64 animate-spin3d preserve-3d">
              {/* Cube Faces */}
              <div className="absolute w-full h-full bg-amber-500/30 border border-amber-300/50 transform translate-z">
                <span className="absolute inset-0 flex items-center justify-center text-4xl font-bold text-white">1</span>
              </div>
              <div className="absolute w-full h-full bg-amber-500/30 border border-amber-300/50 transform rotate-y-90 translate-z">
                <span className="absolute inset-0 flex items-center justify-center text-4xl font-bold text-white">2</span>
              </div>
              <div className="absolute w-full h-full bg-amber-500/30 border border-amber-300/50 transform rotate-y-180 translate-z">
                <span className="absolute inset-0 flex items-center justify-center text-4xl font-bold text-white">3</span>
              </div>
              <div className="absolute w-full h-full bg-amber-500/30 border border-amber-300/50 transform rotate-y-270 translate-z">
                <span className="absolute inset-0 flex items-center justify-center text-4xl font-bold text-white">4</span>
              </div>
              <div className="absolute w-full h-full bg-amber-500/30 border border-amber-300/50 transform rotate-x-90 translate-z">
                <span className="absolute inset-0 flex items-center justify-center text-4xl font-bold text-white">5</span>
              </div>
              <div className="absolute w-full h-full bg-amber-500/30 border border-amber-300/50 transform rotate-x-270 translate-z">
