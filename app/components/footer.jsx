        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex justify-center sm:justify-start space-x-4">
              <a 
                href="https://twitter.com/dsavisualizer" 
                target="_blank" 
              ...
              <a 
                href="https://github.com/dsavisualizer" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://linkedin.com/company/dsavisualizer" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://youtube.com/dsavisualizer" 
                target="_blank" 
                rel="noopener noreferrer"
