        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="flex items-center">
              <span className="text-2xl font-bold text-white">DSA<span className="text-blue-500">Visualizer</span></span>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                <svg className="w-5 h-5 mt-0.5 mr-3 flex-shrink-0" fill="red" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <Link href={link.href} className="hover:text-blue-400 transition flex items-center group">
                    <svg className="w-4 h-4 mr-2 opacity-0 group-hover:opacity-100 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-16 pt-8 border-t border-gray-900">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link href="/sitemap-0.xml" className="text-sm text-gray-500 hover:text-blue-400 transition">Sitemap</Link>
              <Link href="/#review" className="text-sm text-gray-500 hover:text-blue-400 transition">Contact</Link>
            </div>
          </div>
        </div>
      </div>
