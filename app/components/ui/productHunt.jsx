...
const ProductHuntBadge = () => {
  return (
    ...
    >
      {/* Remote SVG badge from Product Hunt: next/image cannot optimise SVG,
          and allowing it would require dangerouslyAllowSVG. Width and height
          are set explicitly, so there is no layout shift. */}
